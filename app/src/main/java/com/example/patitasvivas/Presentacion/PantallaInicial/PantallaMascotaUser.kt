...
@Composable
fun MascotaCard(nombre: String, raza: String, año: String, estadoSalud: String, imagenUrls: List<String>?, Estado: String, Idmascota: String, CorreoUsuario:String,onAdoptar: () -> Unit) {
